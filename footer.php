    ...
    <div class="container py-2">
        <div class="row">
            ...
            <div class="col-xs-6 col-md-4">
                <h5>About</h5>
                <p>Website không chỉ giúp doanh nghiệp tối ưu hóa quản lý, tiếp cận và phân tích dữ liệu khách hàng hiệu quả, mà còn nâng cao tính cạnh tranh trên thị trường.<p>
            </div>
